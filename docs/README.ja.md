...
<p align="center">
  <img src="./blindenv-architecture-light.svg" alt="blindenv防御アーキテクチャ" />
</p>
...
<p align="center">
  <img src="./blindenv-hooks-light.svg" alt="Claude Codeフックアーキテクチャ" />
</p>
...
blindenv cache-restore                キャッシュからシークレットファイルを復元（エージェント破損後）
blindenv cache-refresh                シークレットファイルのキャッシュを更新（.env手動編集後）
